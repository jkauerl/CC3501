...
def trayectoria(C, r, g, b):

    vertices = []
    for i in range(len(C)):
        vertices = np.append(
            vertices, [*C[i], r, g, b], axis=0
        )
    ...
    for i in range(len(C)):
        if i < len(C):
            indices = np.append(
                indices, [i, i + 1, i + 1], axis=0
            )
        else:
            indices = np.append(
                indices, [i, 0, 0], axis=0
            )
...
def createAguaNormalsCube(r, g, b):
    # Defining the location and colors of each vertex  of the shape
    vertices = [
        #   positions         colors   normals
        # Z+
        -0.5, -0.5, 0.5, 0, 0, 1, 0, 0, 1,
        -0.25, -0.25, 0.51, 0, 1, 1, 0, 0, 1,
        ...
        # Z-
        -0.5, -0.5, -0.49, 0, 0, 1, 0, 0, -1,
        -0.25, -0.25, -0.49, 0, 1, 1, 0, 0, 1,
        0.5, -0.5, -0.49, 0, 0, 1, 0, 0, -1,
        0.25, -0.25, -0.49, 0, 1, 1, 0, 0, 1,
        0.5, 0.5, -0.5, 0, 0, 1, 0, 0, -1,
        0.25, 0.25, -0.49, 0, 1, 1, 0, 0, 1,
